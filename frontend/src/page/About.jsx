    ...
    <div className="bg-[#0F1015] text-white min-h-screen font-Montserrat">
      ...
      <section className="relative overflow-hidden pt-32 pb-12">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          >
            We are building more than just an invoicing tool. Chainvoice is the
            financial operating system for Web3, enabling permissionless
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1">
              ...
              <p className="text-gray-400 text-lg leading-relaxed mb-8">
                Chainvoice isn't a black box. Our core logic lives on-chain,
                meaning every invoice, payment, and split is verifiable by
                anyone.
              </p>
              <a
